...
import { getMockImageAnalysis } from "./utils/mockData.js";
...
const useMockData = true; // Aseta tämä trueksi jos haluat käyttää mock dataa testaukseen. Tätä voidaan käyttää testaukseen jotta ei kuluteta API kutsuja turhaan
...
const model = genAI.getGenerativeModel({ model: "gemini-1.5-pro" }); // uusin ilmeisesti 	gemini-1.5-pro-001
